...
export const PERMISSION_GROUPS: Array<{ group: string; items: Array<{ key: string; label: string }> }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "practitioners.edit", label: "Профиль, специализации и задачи" },
      { key: "practitioners.block", label: "Статус и блокировка" },
      { key: "practitioners.reset_password", label: "Сброс пароля" },
      { key: "practitioners.set_password", label: "Назначение пароля" },
      { key: "practitioners.set_rates", label: "Тарифы, цены и комиссия" },
      { key: "practitioners.set_schedule", label: "Управление расписанием" },
      { key: "practitioners.view_earnings", label: "Финансы и начисления" },
      { key: "practitioners.payout", label: "Выплаты практикам" },
      { key: "practitioners.verify", label: "Верификация практиков" },
      { key: "practitioners.manage_documents", label: "Документы и KYC" },
      { key: "practitioners.manage_reports", label: "Отчёты практиков" },
    ],
  },
  {
    group: "Продукт",
