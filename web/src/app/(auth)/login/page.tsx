...
const TEST_ACCOUNTS = [
  ...
  { label: "Суперадмин", email: "admin@test.eterapy.com", password: "admin1234", href: "/admin" },
          ...
          <CardContent>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  type="button"
                  onClick={() => signIn("vk", { callbackUrl: "/cabinet" })}
                  className="flex items-center justify-center gap-2 rounded-lg border border-border/40 bg-[#0077FF]/10 px-3 py-2.5 text-sm font-medium text-[#0077FF] transition-colors hover:bg-[#0077FF]/20 hover:border-[#0077FF]/40">
