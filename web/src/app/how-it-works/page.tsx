...
const steps = [
  ...
  },
  {
    ...
    text: "Что мы услышали, главная развилка, безопасный следующий шаг — и углубление по выбору. Всё сохраняется в Дневник; удалить можно в один клик.",
  },
];

const productGroups = [
  ["Разобраться самому", "Полная картина, подробный разбор, разбор переписки и решение вопроса в чате."],
