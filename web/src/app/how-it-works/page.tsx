...
const steps = [
  ...
  },
  {
    ...
    text: "Полная картина, подробный разбор, разбор переписки, совместимость, Таро, натальная карта, маршрут «7 дней» или встреча со специалистом доступны из каталога /products.",
  },
  {
    step: "06",
...
const productGroups = [
  ["Цифровые углубления", "Полная картина, подробный разбор, разбор переписки, совместимость, 7 дней и Моя карта."],
    ...
    <main className="soft-clarity-page soft-public-page" data-testid="how-it-works-page">
      ...
      <section className="soft-shell" style={{ paddingTop: 64, paddingBottom: 24, maxWidth: 880, margin: "0 auto" }}>
        ...
        <h1 className="soft-h1 mt-3">
          От вопроса <span className="soft-italic">к ответу</span> — и дальше только по вашему выбору
        </h1>
        ...
        <div className="soft-card mt-8" style={{ padding: 28, background: "linear-gradient(160deg, #fffcf5, #f4d9c1)" }}>
          ...
          >
            «Разбор → бесплатный первичный разбор → выбор углубления → результат → Моя карта → специалист при необходимости».
          </p>
        ...
        <div className="soft-card mt-8 p-6 md:p-8">
          ...
          <p className="mt-3 text-sm leading-relaxed text-[var(--soft-ink-soft)]">
            ...
            копить баллы, продолжать «Мою карту» и проходить маршруты со скидкой. Встречи со специалистами
