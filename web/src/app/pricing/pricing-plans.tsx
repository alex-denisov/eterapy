...
const plans = [
  ...
  },
  {
    ...
    perks: [
      ...
      "Все цифровые форматы ETerapy включены",
    ],
    cta: "Подключить Plus",
...
const oneOff = [
  ...
  { t: "Глубокий отчёт", d: "Документ-разбор ситуации", price: "590 ₽" },
  { t: "Разбор переписки", d: "Текст, тон, динамика и варианты ответа", price: "990 ₽" },
  { t: "Совместимость", d: "Парный отчёт по приглашению", price: "990 ₽" },
