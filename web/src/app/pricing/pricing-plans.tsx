...
const plans = [
  ...
  },
  {
    ...
    yearPrice: 4990,
    perks: [
      "Ежемесячные кредиты на цифровые углубления",
      "4 ракурса · практика ясности · скидка на цифровые продукты",
...
const oneOff = [
  ...
  { t: "Глубокий отчёт Basic", d: "Документ-разбор ситуации", price: "490 ₽" },
  { t: "Глубокий отчёт Standard", d: "Рекомендуемый подробный формат", price: "690 ₽" },
  { t: "Глубокий отчёт Pro", d: "Максимальная глубина и план действий", price: "990 ₽" },
  { t: "Разбор переписки Start", d: "Быстрое наблюдение по переписке", price: "299 ₽" },
  { t: "Разбор переписки Deep", d: "Тон, динамика и варианты ответа", price: "890 ₽" },
  { t: "Разбор переписки Pro", d: "Глубокий анализ + расширенные формулировки", price: "1 290 ₽" },
  { t: "Совместимость", d: "Парный отчёт по приглашению", price: "790 ₽" },
