...
const rows = [
  ...
  ["Кредиты ясности", "3 в подарок (14 дн)", "12 / месяц", "35 / месяц"],
  ["4 ракурса ответа", "1 кр / 299 ₽", "включено без кредитов", "включено без кредитов"],
  ["Глубокий отчёт", "4 кр / 690 ₽", "4 кр из кошелька", "включено без кредитов"],
  ["Разбор переписки", "2 кр / 390 ₽", "2 кр из кошелька", "2 кр из кошелька"],
  ["Совместимость («Вы двое»)", "4 кр / 790 ₽", "4 кр из кошелька", "4 кр из кошелька"],
  ["7 дней к ясности", "8 кр / 990 ₽", "8 кр из кошелька", "8 кр из кошелька"],
