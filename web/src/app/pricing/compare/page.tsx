...
const rows = [
  ["Первичный разбор", "гость 1/день", "3 / день", "без лимита"],
  ["Кредиты ясности", "welcome 3 (14 дн)", "12 / месяц", "35 / месяц"],
  ["4 ракурса ответа", "тизер → 1 кр / 299 ₽", "включено без кредитов", "включено без кредитов"],
  ["Глубокий отчёт", "тизер → 4 кр / 690 ₽", "4 кр из кошелька", "включено без кредитов"],
  ["Разбор переписки", "тизер → 2 кр / 390 ₽", "2 кр из кошелька", "2 кр из кошелька"],
  ["Совместимость («Вы двое»)", "тизер → 4 кр / 790 ₽", "4 кр из кошелька", "4 кр из кошелька"],
  ["7 дней к ясности", "тизер → 8 кр / 990 ₽", "8 кр из кошелька", "8 кр из кошелька"],
