...
const GROUPS: ServiceGroup[] = [
  ...
  },
  {
    ...
    cards: [
      { id: "angles", title: "Полная картина", desc: "Мысли · чувства · скрытый смысл · первый шаг. Первая часть разбора бесплатно.", price: "299 ₽", kind: "Цифровое", href: "/products/perspectives", icon: Compass },
      { id: "report", title: "Подробный разбор", desc: "Документ-разбор на 10–15 страниц, который можно сохранить и обсудить.", price: "690 ₽", kind: "Цифровое", href: "/products/deep-report", icon: Bookmark },
      { id: "chat", title: "Разбор переписки", desc: "Тон, эмоции, границы и варианты ответа.", price: "390 ₽", kind: "Цифровое", href: "/products/chat-analysis", icon: MessagesSquare },
    ],
  },
  {
    id: "together",
    title: "Вместе",
    cards: [
      { id: "together", title: "Вместе", desc: "Взгляд со стороны · сверить взгляды · совместимость. Один общий вопрос — и бережный разбор для двоих или близких.", price: "от 790 ₽", kind: "Для двоих и близких", href: "/products/pair", icon: Users },
    ],
  },
  {
    id: "esoteric",
    title: "Эзотерика",
    cards: [
      { id: "tarot-d", title: "Расклад Таро", desc: "Цифровой расклад с бережной интерпретацией.", price: "390 ₽", kind: "Цифровое", href: "/products/tarot", icon: Moon },
      { id: "astro-d", title: "Натальная карта", desc: "Базовый разбор натальной карты.", price: "590 ₽", kind: "Цифровое", href: "/products/natal-chart", icon: Compass },
      { id: "synastry-d", title: "Совместимость по звёздам", desc: "Две натальные карты рядом: ресурсы и разные ритмы пары.", price: "990 ₽", kind: "Цифровое", href: "/products/synastry", icon: Compass },
      { id: "numero-d", title: "Числовой портрет", desc: "Нумерологический разбор без фатальных обещаний.", price: "390 ₽", kind: "Цифровое", href: "/products/numerology", icon: Sparkles },
    ],
  },
  {
    id: "specialists",
    ...
    cards: [
      { id: "specialist", title: "Поговорить со специалистом", desc: "Психологи, коучи, юристы, финансовые консультанты и эзотерики. 60 минут онлайн, цена видна до записи — специалист заранее видит ваш разбор.", price: "от 2 000 ₽", kind: "Встреча", href: "/practitioners", icon: Heart, highlight: true },
    ],
  },
];
