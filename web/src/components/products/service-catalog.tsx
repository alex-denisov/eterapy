...
const SERVICES: ServiceCard[] = [
  ...
  { id: "practice", title: "Ежедневная практика", desc: "Ежедневные короткие вопросы, задания и мягкий ритм.", price: "0 ₽", cat: "practice", kind: "Бесплатно", href: "/products/clarity-practice", icon: Leaf },
  ...
  { id: "circle", title: "Круг", desc: "Бережный групповой формат: 2–5 участников и один общий вопрос.", price: "790 ₽", cat: "social", kind: "Для круга", href: "/products/circle", icon: Users },
  ...
  { id: "7days", title: "7 дней", desc: "Маршрут по 5–10 минут в день — первый день бесплатно.", price: "990 ₽", cat: "practice", kind: "Маршрут", href: "/products/seven-days", icon: Calendar },
