...
const faqs = [
  {
    ...
    a: "Фиксированная цена за сессию (не поминутная), прозрачная комиссия 25%, AI-инструменты для самопознания, международные платежи через Stripe. Мы — единственная РФ-платформа с такой комбинацией.",
  },
  {
    q: "Вы проверяете «магические способности» практиков?",
    a: "Нет, и мы об этом честно говорим. Мы проверяем личность (KYC), этику (тест-консультации) и отслеживаем репутацию через отзывы от оплаченных сессий.",
  },
  {
  ...
  },
  {
    ...
    a: "Фиксированная цена видна до бронирования. Оплата через защищённую кассу (ЮKassa для РФ, Stripe для международных). Деньги удерживаются до завершения сессии.",
  },
  {
    q: "Что такое AI-инструменты?",
    a: "Бесплатные инструменты самопознания: расклад Таро с AI-интерпретацией, нумерологический расчёт, check-in с рефлексивными вопросами. 3 сессии в месяц бесплатно.",
  },
  {
