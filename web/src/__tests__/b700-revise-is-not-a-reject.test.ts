...
function reviewerAnswer(decision: "REVISE" | "REJECT") {
  return JSON.stringify({
    ...
    issues: ["Превышение лимита площадки на девять символов"],
    revisionBrief: ["Сократить текст на девять символов"],
    revisedText: "",
    summary: decision === "REVISE"
      ? "Неустранённые дефекты из прошлого раунда: превышение лимита символов. Новых блокирующих замечаний нет."
