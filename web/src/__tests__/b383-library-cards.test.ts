...
//
// B550 добавляет три карточки в кластер «ИИ-психолог» — единственный, где
// замер Вебмастера 2026-08-12 показал живые клики (2 клика, позиция 4 при
// шести запросах на весь сайт): анонимность (990 показов), ночная тревога
// (1 073) и разговор с нейросетью вместо человека (558).
const TARGET_DISTRIBUTION: Record<LifeLibraryTopic, number> = {
  "Отношения": 30 + 8,
  "Повторяется одно и то же": 18 + 1,
  "Тревога и состояние": 18 + 1,
