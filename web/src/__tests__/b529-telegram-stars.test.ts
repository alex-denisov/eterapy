...
describe("B529 — курс и цена в звёздах", () => {
  it("округляет звёзды ВВЕРХ: недобрать с покупателя нельзя", () => {
    // 790 ₽ при курсе 1.6 ₽/звезда = 493.75 → 494.
    expect(starsForKopecks(79000, 1.6)).toBe(494);
    // Ровное деление остаётся ровным.
