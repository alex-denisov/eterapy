...
const resolveChatAnalysis: Resolver = (signals) => {
  ...
  // бывший(ая), друг, другой и пустой контекст → переосмыслить свой вопрос.
  return {
    slug: "reframe",
    eyebrow: "следующий шаг",
    reason: "Если хочется увидеть свой вопрос иначе — «Переосмысление» разложит его на мысли, чувства, другой взгляд и шаг.",
  };
};
...
const DEFAULT_NEXT: Partial<Record<string, Pick>> = {
  ...
  "human-design": {
    slug: "reframe",
    eyebrow: "следующий шаг",
    reason: "Перенесите это знание на живой вопрос — «Переосмысление» поможет увидеть конкретную ситуацию иначе.",
  },
  "surname-story": {
    slug: "family-scenarios",
    eyebrow: "идём глубже",
  ...
  "family-scenarios": {
    slug: "reframe",
    eyebrow: "следующий шаг",
    reason: "Чтобы перенести это на сегодняшний вопрос — «Переосмысление» поможет увидеть его иначе.",
  },
  synastry: {
    slug: "pair",
    eyebrow: "следующий шаг",
