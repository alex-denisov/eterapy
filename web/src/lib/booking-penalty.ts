 ...
 *
 * Политика (legal-pack, Документ 1 §7.9 и Документ 12): при отмене <24ч или
 * неявке клиента удерживается ВСЯ стоимость сессии (owner 2026-07-22, B567:
 * частичного возврата нет). «Удержанная сумма распределяется между специалистом
 * и платформой на общих условиях» — то есть проходит ту же комиссионную
 * матрицу, что и обычная сессия: практик получает (удержание × (1 − комиссия%)),
 * платформа — комиссию. Размер — LATE_CANCEL_RETENTION_PERCENT.
 *
