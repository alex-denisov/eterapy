...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    answer: "Если сессию отменяет специалист или не выходит на неё — деньги возвращаются полностью, а при поздней отмене платформа дополнительно начисляет компенсационные баллы. Пользователь может бесплатно отменить сессию не позднее чем за 24 часа до начала; при более поздней отмене или неявке удерживается вся стоимость — частичного возврата нет, но специалист может отменить удержание целиком.",
  },
] as const;
