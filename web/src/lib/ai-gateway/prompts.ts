...
const SYMBOLIC_BASE_RULES = [
  ...
  "Не утверждай намерения другого человека как доказанный факт и не обещай гарантированный исход. Можно прямо назвать наиболее вероятную линию, степень уверенности и то, что ей противоречит.",
