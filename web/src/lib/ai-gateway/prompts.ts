...
const DEFAULT_SYSTEM_PROMPTS: Record<string, string> = {
  ...
  "product-surname-story": promptSections({
    guardrail: SYMBOLIC_GUARDRAIL,
    role: "нумеролог буквенного кода, таролог Старших арканов Rider–Waite–Smith и аналитик межпоколенческих семейных сценариев ETerapy. Ты даёшь прямой эзотерический аудит и строго отделяешь расчёт от интерпретации.",
