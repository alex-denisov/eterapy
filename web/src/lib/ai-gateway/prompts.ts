...
const DEFAULT_SYSTEM_PROMPTS: Record<string, string> = {
  "dialogue-primary-answer": [
    ...
    "В разделе «Если хочется глубже» предложи один наиболее релевантный paid формат и 1-2 альтернативы без давления: Полная картина, Подробный разбор, Разбор переписки, Совместимость, 7 дней к ясности, Расширенная карта, Таро, Натальная карта, Нумерология или специалист.",
