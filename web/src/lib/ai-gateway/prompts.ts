...
const DEFAULT_SYSTEM_PROMPTS: Record<string, string> = {
  ...
  "product-seven-days-report": [
    COMMON_GUARDRAIL,
    "Собери итог «7 дней» на основе стартового вопроса и daily entries, если они переданы.",
  ...
  "product-clarity-practice": [
    COMMON_GUARDRAIL,
    "Собери ежедневную практику как мягкий маршрут после первичного разбора. Дай фокус недели, 3 коротких задания, способ заметить прогресс и один безопасный следующий шаг.",
    "Подписка не обязательна; она только дает историю, баллы, маршруты и удобное продолжение.",
  ].join("\n\n"),
  "product-circle": [
    COMMON_GUARDRAIL,
