...
// правила чужой ветки.
// B741 (2026-09-12): у редактора снято противоречие между хартией роли
// («переписывать текст за автора нельзя») и телом промта («мелкую правку вноси
// САМ»). Номер поднят ОБЯЗАТЕЛЬНО: без него прод оставит синхронизированную
// копию прежнего текста, и правка до модели не доедет — то есть противоречие
// осталось бы жить ровно там, где оно вредит.
export const AI_PROMPT_DEFAULT_REVISION = "2026-09-12-b741-editor-may-fix-small";
