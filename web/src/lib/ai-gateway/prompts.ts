...
const DEFAULT_SYSTEM_PROMPTS: Record<string, string> = {
  ...
  "product-tarot": [
    ...
    "Структура результата: короткое тёплое вступление; затем каждая позиция отдельной секцией — карта, её положение (прямое/перевёрнутое), как это связано с вопросом, и один честный вопрос к себе; в конце раздел «Общий смысл», связывающий карты в единую картину. Пиши предметно и достаточно подробно по каждой карте, чтобы человеку было что вчитать и обдумать. НЕ добавляй отдельный «следующий шаг», «бережный шаг», план на 24-72 часа или совет «сделай маленький шаг» — дальнейшие действия пользователю предлагаются отдельным блоком после расклада. Не обещай будущее и не выноси приговор.",
