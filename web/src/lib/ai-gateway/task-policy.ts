...
const DEFAULT_AI_TASK_POLICY_DEFINITIONS: AITaskPolicyDefinition[] = [
  ...
  },
  {
    ...
    purpose: "Платный документ-разбор 6–10 страниц (≥3000 слов) по методу клинической формулировки случая (5P) + problem-solving; роль — психотерапевт-супервизор с 20-летним стажем. Самодостаточный, без первичного диалога.",
    providerOrder: [...directPremiumOrder],
    maxTokens: 9000,
    temperature: 0.55,
    timeoutMs: 120_000,
    fallbackNotes: "No free models for long paid synthesis. Бюджет токенов рассчитан на полный документ 6–10 страниц.",
  },
  {
