...
const DEFAULT_AI_TASK_POLICY_DEFINITIONS: AITaskPolicyDefinition[] = [
  ...
  },
  {
    ...
    purpose: "Платный разбор по методу когнитивного рефрейминга (самодостаточный, без первичного диалога).",
  ...
  },
  {
    ...
    purpose: "Платный документ-разбор 6–10 страниц по методу клинической формулировки случая (5P + problem-solving); самодостаточный, без первичного диалога.",
    providerOrder: [...directPremiumOrder],
    maxTokens: 7000,
    temperature: 0.5,
    timeoutMs: 90_000,
