...
const DEFAULT_AI_TASK_POLICY_DEFINITIONS: AITaskPolicyDefinition[] = [
  ...
  },
  {
    ...
    purpose: "Ежедневная практика: вопрос дня → ракурс дня → маленький шаг. Бесплатный ритуал самонаблюдения.",
    providerOrder: [...freeOrder],
    modelPreferences: { [AIProvider.OPENROUTER]: "openrouter/free" },
    maxTokens: 500,
    temperature: 0.8,
  ...
  {
    feature: "product-joint-session",
    enabled: true,
    tier: "premium",
    title: "Совместная сессия со специалистом",
    purpose: "Подготовка к живому взаимодействию с практиком и post-session summary.",
    providerOrder: [...directPremiumOrder],
    maxTokens: 1800,
    temperature: 0.35,
    timeoutMs: 45_000,
    fallbackNotes: "Живой специалист — слой сопровождения, не emergency support и не подписочный gate.",
  },
  {
