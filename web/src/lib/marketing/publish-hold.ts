...
const CHANNEL_ERROR_MARKERS = [
  ...
  // B698: отказы браузерной дороги Дзена. Все три говорят о НАШЕЙ стороне или о
  // площадке — истёкшая сессия владельца, переехавший редактор, несогласованный
  // договор приложения и сервиса. Материал здесь ни при чём, и сжигать его слот
  // из-за них нельзя (`feedback_defer_unless_material_is_at_fault`).
  "редактор дзена изменился",
  "сессия дзена истекла",
