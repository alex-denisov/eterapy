...
// B525 (2026-07-16) — редакция 1.1: разделение договоров (услуги ETerapy vs
...
// не отдельный акцепт). Bump версии инвалидирует versionId во всех consent-логах
// и привязках оферты к платежам — это намеренно.
export const LEGAL_PACK_VERSION = "1.1";
export const LEGAL_PACK_PUBLISHED_AT = "2026-07-16";
