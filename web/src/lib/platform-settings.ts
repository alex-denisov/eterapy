...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  "product.compatibility-by-date.price":       "890",
  "product.numerology.price":     "890",
  "product.horoscope.price":         "590",
  "product.arcana.price": "890",
  "product.family-questions.price": "1090",
  "product.human-design.price":   "590",
  "product.surname-origin.price":  "590",
  "product.tarot.credits":        "2",
  "product.natal-chart.credits":  "2",
  "product.compatibility-by-date.credits":     "3",
  "product.numerology.credits":   "3",
  "product.horoscope.credits":       "2",
  "product.arcana.credits": "3",
  "product.family-questions.credits": "4",
  "product.human-design.credits": "2",
  "product.surname-origin.credits": "2",
