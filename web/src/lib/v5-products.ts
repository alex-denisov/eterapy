...
export const v5Products: V5Product[] = [
  {
    ...
    mechanics: ["один вопрос в день", "короткий ракурс", "мягкие напоминания", "баллы за осмысленное действие"],
  ...
  },
  {
    ...
    price: "590 ₽",
    priceMeta: "или −4 балла · с картой партнёра — синастрия 990 ₽",
    creditPrice: "или −4 балла · с картой партнёра — синастрия 990 ₽",
    creditCost: 4,
    tone: "paid",
    cta: "Открыть карту",
