...
export const v5Products: V5Product[] = [
  ...
  },
  {
    ...
    summary: "Развернутый отчет по ситуации на основе диалога: Basic 490 ₽, Standard 690 ₽ или Pro 990 ₽.",
    price: "490–990 ₽",
    tone: "paid",
    cta: "Посмотреть глубину",
    mechanics: ["предпросмотр до оплаты", "открытие через entitlement", "сохранение в Мою карту", "экспорт и удаление"],
  ...
  },
  {
    ...
    summary: "Анализ текста или скрина переписки: быстрый Start, глубокий Deep или Pro с вариантами ответа.",
    price: "299–1 290 ₽",
    tone: "private",
    cta: "Разобрать переписку",
    mechanics: ["вставка или загрузка", "предупреждение о персональных данных", "удаление источника", "варианты ответа в Pro"],
