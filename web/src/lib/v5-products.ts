...
const RAW_V5_PRODUCTS: V5Product[] = [
  ...
  },
  {
    ...
    summary: "По форме фамилии видно её происхождение, вероятное занятие или местность предков — это короткая история фамилии бесплатно. Полный родовой разбор бережно соберёт родовую тему и то, что может откликаться у вас сегодня. Не гадание и не приговор роду, а тёплый взгляд на корни.",
    ...
    result: "Короткая история фамилии и бережный родовой разбор — без гаданий и приговоров.",
  },
];
