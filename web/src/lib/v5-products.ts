...
const RAW_V5_PRODUCTS: V5Product[] = [
  ...
  },
  {
    ...
    name: "Тайна имени и фамилии",
    eyebrow: "ономастика · корни, звучание и личный образ",
    summary: "Личное досье имени и фамилии: происхождение, корень, география, социальная история, варианты латиницы, фоносемантика и символический портрет характера. Факты и гипотезы показаны отдельно.",
    ...
    tone: "paid",
    cta: "Исследовать имя",
    directCta: "Исследовать имя",
    productKey: "surname-story",
    mechanics: ["имя и фамилия", "версии происхождения", "звучание и эмоциональный образ", "латиница и архивный маршрут"],
    privacy: "Имя и фамилия используются только для разбора и не публикуются без вашего согласия.",
    result: "Паспорт имени: происхождение, социальная история, звучание, символическое зеркало и практический маршрут проверки.",
  },
];
