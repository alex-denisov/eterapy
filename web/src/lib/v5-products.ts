...
const RAW_V5_PRODUCTS: V5Product[] = [
  ...
  // (новые расклады «Вместе» идут под productKey "pair").
  {
    ...
    slug: "pair",
    route: "/products/pair",
    // B674 (владелец 2026-08-05): имя услуги теперь называет предмет и
    // механику. Слаг `pair` и productKey `pair`/`compatibility` — ключи
    // биллинга и legacy-результатов, их трогать нельзя.
    name: "Разбор для двоих",
    ...
    directCta: "Открыть разбор для двоих",
  ...
  },
  {
    ...
    // B366: 590 ₽ / 2 балла (295 ₽/балл).
    price: "590 ₽",
    priceMeta: "или −2 балла · с картой партнёра — совместимость по дате 890 ₽",
    creditPrice: "или −2 балла · с картой партнёра — совместимость по дате 890 ₽",
    creditCost: 2,
    tone: "paid",
    cta: "Открыть карту",
  ...
  },
  {
    ...
    eyebrow: "совместимость по дате рождения · две карты рядом",
  ...
  {
    slug: "horoscope",
    route: "/products/horoscope",
    name: "Гороскоп",
    eyebrow: "гороскоп момента · прямой ответ да или нет",
  ...
  {
    slug: "arcana",
    route: "/products/arcana",
    name: "Арканы судьбы",
    eyebrow: "арканы судьбы · постоянная пара карт по дате рождения",
  ...
  {
    // B389 (M26): «Семейные вопросы» — не в каталоге-простыне (его нет в 5 группах),
    // продаётся через рекомендацию Дневника; страница-услуга нужна для рендера/оплаты.
    slug: "family-questions",
  ...
  },
  {
    ...
    eyebrow: "фамилия · число рода · Старший Аркан",
