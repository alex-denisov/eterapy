...
export const v5Products: V5Product[] = [
  ...
  },
  {
    ...
    name: "Расклад Таро",
    eyebrow: "Символический разбор",
    summary: "Три карты на ваш вопрос. Не оракул и не приговор, а метафорический способ увидеть развилку и следующий шаг.",
    price: "390 ₽",
    creditPrice: "или -2 кредита ясности",
    tone: "paid",
    cta: "Разложить карты",
  ...
  },
  {
    ...
    eyebrow: "Астрология как язык тем",
    summary: "Базовый разбор натальной карты с фокусом на вопрос пользователя, без детерминизма и обещаний будущего.",
    price: "590 ₽",
    creditPrice: "или -4 кредита ясности",
    tone: "paid",
    cta: "Открыть карту",
  ...
  },
  {
    ...
    eyebrow: "Нумерология без фатальности",
    summary: "Числа имени и даты рождения как карта вопросов, циклов и повторяющихся тем, а не как приговор.",
    price: "390 ₽",
    creditPrice: "или -2 кредита ясности",
    tone: "paid",
    cta: "Собрать портрет",
  ...
  },
  {
    ...
    eyebrow: "Совместная живая сессия",
    summary: "Один час, два специалиста: символический разбор и психотерапевтическая проверка реальности в одной встрече.",
    price: "от 4 500 ₽",
    creditPrice: null,
    tone: "paid",
