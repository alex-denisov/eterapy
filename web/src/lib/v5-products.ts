...
export const v5Products: V5Product[] = [
  ...
  },
  {
    ...
    name: "Совместимость",
    eyebrow: "Согласие партнера · бесплатный teaser",
    summary: "Парный отчет, который открывается только после согласия и завершения обеих сторон.",
    // B322: docs §10 — рекомендованная цена 790 ₽ (was 590). Teaser остаётся бесплатным.
    price: "790 ₽",
    priceMeta: "один отчёт на двоих · бесплатный teaser",
  ...
  },
  {
    ...
    // B322: docs §11 — день 1 бесплатно, полный маршрут 990 ₽. Tone "free" чтобы
    // отражать free teaser (day 1).
    price: "990 ₽",
  ...
  },
  {
    ...
    name: "Круг ясности",
    eyebrow: "групповой формат · бесплатный teaser",
    ...
    // B322: docs §9 — teaser 0 ₽, полный отчёт 790 ₽.
    price: "790 ₽",
    priceMeta: "полный отчёт · teaser 0 ₽",
    creditPrice: "или −4 кредита ясности",
    creditCost: 4,
    tone: "free",
    cta: "Создать круг",
    directCta: "Открыть круг ясности",
    directHref: "/checkin?entry=circle",
  ...
  },
  {
    ...
    eyebrow: "парный формат · бесплатный teaser",
    summary: "Парный формат: два человека, одна ситуация. Каждый отвечает отдельно, ETerapy собирает совместную картинку без раскрытия деталей.",
    // B322: docs §8 — teaser 0 ₽, полный 790 ₽, Pro 990 ₽.
    price: "790 ₽",
    priceMeta: "полный отчёт · teaser 0 ₽",
    creditPrice: "или −4 кредита ясности",
    creditCost: 4,
    ...
    result: "Совместный отчёт о различиях ожиданий и одной точке роста.",
  },
  {
    slug: "my-map",
