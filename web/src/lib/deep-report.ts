...
export function heuristicDeepReport(dialogue: DialogueForDeepReport) {
  ...
  return normalizeReport([
    ...
    "",
    "1. Обзор ситуации",
    "Сейчас важно не искать один окончательный ответ, а отделить факты, чувства и ожидания. Вопрос уже содержит напряжение между желанием определённости и страхом поспешить.",
    "",
    "2. Главная развилка",
    ...
    "",
    "6. Бережное резюме",
    "Вы не обязаны решать все сразу. Достаточно сделать следующий шаг так, чтобы он увеличивал понимание, а не давление.",
    "",
    preview,
  ].join("\n"));
}
