...
function buildSystemPrompt(input: {
  ...
  return [
    ...
    "",
    "Правила:",
    "- m: 1-2 предложения. ОБЯЗАТЕЛЬНО процитируй или перескажи конкретное слово/фразу из ПОСЛЕДНЕЙ реплики пользователя. Пустое m недопустимо, пока диалог продолжается",
