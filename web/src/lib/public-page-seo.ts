...
export const publicPageSeo: Record<PublicSeoRoute, PublicPageSeo> = {
  ...
  "/tarot": {
    ...
    description: "Waitlist-страница нового направления ETerapy: Таро как язык метафор, этичный разбор, фиксированные форматы и запрет на фатальные прогнозы.",
    schemaKind: "Product",
  },
  "/astro": {
    title: "Астрология в ETerapy — натальная карта как символический портрет",
    description: "Waitlist-страница астрологических форматов ETerapy: натальная карта, транзиты и синастрия как темы для осмысления, не предсказания.",
    schemaKind: "Product",
  },
  "/numerology": {
    title: "Нумерология в ETerapy — числовой портрет без фатальности",
    description: "Waitlist-страница нумерологических форматов ETerapy: числа как карта вопросов, циклов и повторяющихся тем, а не приговор.",
    schemaKind: "Product",
  },
  "/joint": {
    title: "Совместная сессия ETerapy — эзотерик и психотерапевт",
    description: "Пилотный формат ETerapy: один час, два специалиста, символический язык и безопасный практический следующий шаг.",
    schemaKind: "Product",
  },
