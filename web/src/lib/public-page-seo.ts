...
export const publicPageSeo: Record<PublicSeoRoute, PublicPageSeo> = {
  ...
  "/products/reframe": {
    ...
    description: "Когнитивный рефрейминг одной ситуации: мысли против фактов, чувства, другой взгляд и первый шаг. Первый угол бесплатно.",
    schemaKind: "Product",
  },
  "/products/deep-report": {
    title: "Подробный разбор — ETerapy",
    description: "Документ-разбор ситуации на 6–10 страниц по методу клинической формулировки случая: что происходит, что удерживает, опоры, сценарии и маршрут шагов. Оглавление и первый блок бесплатно.",
    schemaKind: "Product",
  },
