...
export const publicPageSeo: Record<PublicSeoRoute, PublicPageSeo> = {
  ...
  "/products/deep-report": {
    ...
    description: "Документ-разбор ситуации на 6–10 страниц по методу клинической формулировки случая: что происходит, что удерживает, опоры, сценарии и маршрут небольших шагов.",
    schemaKind: "Product",
  },
