...
const PRODUCT_SECTION_TITLES: Record<string, string[]> = {
  ...
  "compatibility-by-date": ["Общий рисунок связи", "Притяжение и ресурс пары", "Где возникают трения", "Разные темпы и ожидания", "Коммуникация и конфликт", "Главная динамика вашей пары", "Ответ на вопрос пары", "Что показывает карта отношений", "Что проверить в реальном разговоре"],
