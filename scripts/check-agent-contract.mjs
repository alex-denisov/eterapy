 ...
 * все». 11 августа 2026 обнаружилось, что в этом репозитории было три симлинка
 * из шести: OpenCode, Antigravity и ZCode месяцами работали без единого
 * проектного скилла и никто этого не замечал — расхождение молчаливое, агент не
 * жалуется на скилл, о существовании которого не знает.
 *
