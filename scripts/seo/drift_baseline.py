...
# Baselines are per-project: two repositories must not share one drift history.
# SEO_DRIFT_DB overrides the location outright; otherwise the DB lives next to
# this toolkit inside the project that owns it.
DB_DIR = os.path.expanduser(
    os.environ.get("SEO_DRIFT_DB") or os.path.join(SCRIPTS_DIR, ".state", "drift")
)
